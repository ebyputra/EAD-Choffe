...
?>
  <body style="background:url('asset/image/kopi10.jpg');background-repeat: no-repeat;background-size: cover;height: 910px;">
    <div class="container-fluid">
        <div class="row-fluid" style="margin-top:80px">
            <center>
                <div style="color: #f4f7f9;text-shadow: -4px -2px 4px #000000">
                    <h1>Selamat Datang di EAD-Choffe</h1>
                </div>
                <blockquote class="blockquote" style="color: #f4f7f9;text-shadow: -4px -2px 4px #000000">" Siap Melayani Dengan Sepenuh Hati "<blockquote>
            </center>
        </div>
        <div class="row">
